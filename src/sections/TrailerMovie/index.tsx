...
const Trailers = () => {
  ...
  const movie = Object.keys(clickedTrailer).length > 0 ? clickedTrailer : featured && featured.length > 0 && featured[0]?.movie;
          ...
          <div className="featured-videos__content">
            <div className="featured-videos__content-info-movies">
              ...
              <div className="info-movies-actions">
                {clickedTrailer?.key !== "" && <div
                className="button"
                title={`Ver trailer de ${movie.title || movie.name} no Youtube`}
            ...
            <div className="featured-videos__content-trailers title-tabs">
              <h4>Últimos Lançamentos</h4>
              <Tabs options={options} goTo={handleTabValue} />
              {featured && featured.length > 0 && (
                <div className="play-area">
                  <ListView data={featured} handleClick={handleClickTrailer} width={180} />
                </div>
              )}
            </div>
          </div>
